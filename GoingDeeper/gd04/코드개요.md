...
| 버그 | 발견일 | 수정일 | 상태 |
|------|--------|--------|------|
| tkinter 스레딩 오류 | 2025-11-23 | 2025-11-23 | 0 |
| Loss 너무 높음 (17-20) | 이전 | 이전 | 0 |
| _pad_to_square bbox 미업데이트 | 이전 | 이전 | 0 |
| n_object==0 파싱 오류 | 이전 | 이전 | 0 |
| Inference bbox clipping | 이전 | 이전 | 0 |
| encode_pt format 불일치 | 이전 | 이전 | 0 |
