...
![No Augmentation Training Curves](checkpoints_noaug/no_aug_training_curves.png)
...
![Small Augmentation Training Curves](checkpoints_small_aug/training_curves_SMALLAUG.png)
...
![Hard Augmentation Training Curves](checkpoints_hardaug/training_curves_HARDAUG.png)
...
![Strongest Augmentation Training Curves](checkpoints/training_curves.png)
...
현재 **mAP@0.5: 4~4.5%**로 낮은 성능을 보이고 있습니다.
...
- 실제 응용(예: 웹캠 얼굴 감지)에서는 **충분히 사용 가능**한 수준입니다.
- **`realtime.py`로 웹캠 테스트 시 일반적인 거리(50~100cm)의 얼굴은 잘 감지됩니다.**
>>>>>>> f70e681fdf0ef7f227a28478b29e742126c20c0f
...
>>>>>>> 077b18f7f657241e4fc6c5c4f2ffdad7c34b51e0
